...
const Athlete = () => {
  ...
  return (
    <div className="p-8 rounded-2xl bg-gradient-to-br from-[#04121a] to-[#0a1b2a] border border-slate-700">
      <h2 className="text-2xl font-bold mb-4">{t("athlete.title")}</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Stat label={t("athlete.stats.position")} value="Forward" />
        <Stat label={t("athlete.stats.matches")} value="12 this season" />
        <Stat label={t("athlete.stats.goals")} value="5" />
      </div>
